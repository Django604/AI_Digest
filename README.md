...
- 2026 款探陆独立趋势保留截至 `2026-09-09` 的既有数据，后续不再更新该独立板块；批量截图始终跳过探陆，`2026-10` 起 NEV 趋势页不再生成探陆板块，原有历史月份文件不删除。全车系有效线索继续按源表全量汇总，包含 `2026-09-09` 之后的探陆数据及车型列为空白的 NEV 数据；空白车型不生成独立趋势板块。
